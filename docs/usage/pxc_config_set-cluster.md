...
```
  -h, --help                                help for set-cluster
      --portworx-service-name string        Kubernetes name for the Portworx service (default "portworx-api")
      --portworx-service-namespace string   Kubernetes namespace for the Portworx service (default "kube-system")
      --portworx-service-port string        Port for the Portworx SDK endpoint in the Kubernetes service (default "9020")
```
