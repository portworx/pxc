...
Manage Kubernetes pvcs on a Portworx cluster
...
* [pxc pvc describe](pxc_pvc_describe.md)	 - Describe Portworx volume for Kubernetes PVCs
* [pxc pvc list](pxc_pvc_list.md)	 - Show Portworx volume information for Kubernetes PVCs
